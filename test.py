...
def main():
	...
	parser.add_argument('--model_dir', type=str, default='data/test_model_13')
	...
	parser.add_argument('--test_model', type=str, default='27000.pt')
